...
console.log('População total:', getPopulation());
...
console.log('Area total:', getTotalArea());
...
const longestName = () => countries.reduce((longestName, actualName) => longestName.name.length > actualName.name.length ? longestName : actualName);
...
const countA = () =>  names.reduce((acc, curr) => acc + curr.split('a').length, 0);
