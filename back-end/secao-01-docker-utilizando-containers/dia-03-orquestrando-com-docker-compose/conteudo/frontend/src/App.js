...
function App() {
  ...
  return (
    <div className="App">
      <p className="Contrast-text"><b>🐋 Aprendendo a fazer volumes, atualizado!</b></p>
      {
        content?.length > 0 
      ...
      <footer className="Contrast-text">
        <p>🚀 <b>#VQV</b></p>
        <p><a target="_blank"href="https://gabecmelo.github.io/portfolio/">gabecmelo.portfolio.com</a></p>
      </footer>
    </div>
  );
}
